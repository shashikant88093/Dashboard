...
import { Card, CardBody, CardHeader, Container, Row, Col, Input } from 'reactstrap';
...
import '../../addOrEditInventory/inventoryTabs/style.css'

const data = [{ name: "group_test", description: "group testing" },
...
class Groups extends Component {
  ...
  handelAddGroupClick() {
    this.setState({ isGroup: true, isEditGroup: false, isGroupOpen: true }, () => {
    });
  }
  handelEditGroupClick() {
    this.setState({ isEditGroup: true, isGroup: false, isGroupOpen: true }, () => {
    });
  }
  onCloseGroupModal = () => {
    this.setState({
  ...
  render() {
    ...
    if (this.state.isGroup === true || this.state.isEditGroup === true) {
      addGroup = (
        <Modal open={this.state.isGroupOpen} onClose={this.onCloseGroupModal} center>
          <br></br>
                      ...
                      <Row>
                        <div className="col-md-12">
                          <DualListBox canFilter
                            ...
                            icons={{
                              moveLeft: <span className="zmdi zmdi-chevron-left" />,
                              moveAllLeft: [
                                <span key={0} className="zmdi zmdi-chevron-left" />,
                                <span key={1} className="zmdi zmdi-chevron-left" />,
                              ],
                              moveRight: <span className="zmdi zmdi-chevron-right" />,
                              moveAllRight: [
                                <span key={0} className="zmdi zmdi-chevron-right" />,
                                <span key={1} className="zmdi zmdi-chevron-right" />,
                              ],
                              moveDown: <span className="zmdi zmdi-chevron-down" />,
...
export default withStyles(null, { withTheme: true })(Groups);