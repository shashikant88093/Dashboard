      ...
      <div
        className={
          !this.state.ToggleButton
            ...
            : `app-sidebar-toggle d-none${drawerStyle}`
        }
      >
        <Drawer
          ...
          classes={{
            paper: !this.state.ToggleButton ? "side-nav" : "side-nav-toggle"
          }}
        >
          {/* <UserInfo ToggleButton={this.state.ToggleButton} /> */}
          <SidenavContent
            ToggleButton={this.state.ToggleButton}
            toggleButtonHandler={this.toggleHandler}
          />
        </Drawer>
      </div>
    );
